...
const CardDetails = () => {
  ...
  return (
    <>
      <div className="container mx-auto max-w-[1328px] gap-8 flex flex-wrap p-3 flex-col md:flex-row items-center">
        <a
      ...
      <div className="max-w-[1000px] m-auto">
        <h3 className="text-black text-xl mt-4">
          Cart | {products.length} {products.length <= 1 ? "item" : "items"}
        </h3>
        ...
        <div className="flex justify-center items-start gap-8 mt-4">
          <div>
            {products.map((data) => (
              <div
                className="flex items-start justify-between gap-12 border px-4 py-4 mb-4 rounded-lg"
                key={data.id}
              >
                <img src={data.image} className="w-24" alt="" />
                <div className="flex flex-col leading-8">
                  <h2 className="text-2xl font-medium ">{data.title}</h2>
                  <p className="text-lg">${data.price}</p>
                  <span className="text-lg">Size: L</span>{" "}
                  <span className="text-lg">Qty: 1</span>
                  <button
                    className="flex items-center gap-1 self-start mt-4 text-black font-medium"
          ...
          <div className="flex flex-col gap-4 border p-4 rounded-lg">
            <h3 className="text-[#7C7C85] font-medium text-lg">
              Price Details
            </h3>
            <div className="flex justify-between items-center">
              <p className="text-[#7C7C85] font-medium text-lg">
                Total Product Price:
              </p>
              <p>${allproductPrice}</p>
            </div>
            <hr />
            <div className="flex justify-between items-center">
              <p className="text-black font-medium text-lg">Order Total:</p>
              <p>${allproductPrice}</p>
            </div>
            ...
            <Link to="/login">
              <button className="border px-36 py-2 bg-[#9F2089] text-white text-xl">
                Continue
              </button>
            </Link>
