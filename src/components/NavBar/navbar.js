      ...
      <div className="container mx-auto max-w-[1328px] gap-8 flex flex-wrap p-3 flex-col md:flex-row items-center">
        ...
        <div className="relative w-[28rem] ">
          ...
          <input
            type="search"
            id="default-search"
            className="block w-full p-4 pl-10 text-base font-medium  text-gray-900 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="Try Saree, Kurti or Search by Product Code"
            required
          />
        </div>

        <nav className="md:ml-auto flex flex-wrap items-center text-[1.3rem] gap-8  justify-center">
          <p>Download App</p>
        ...
        <div className=" flex items-center gap-8">
          ...
          {isLoggedIn ? (
            <div className="">
              <div className="flex flex-col items-center">
                <img
                  src="https://tse3.mm.bing.net/th?id=OIP.ODW2UKCKy206wOV7WwAx0gHaHa&pid=Api&P=0&h=180"
                  alt=""
                  className="w-8"
                />
            ...
            <Link to={"/cartdetails"}>
              <div>
                ...
                <p>Cart {items.length <= 0 ? "" : items.length}</p>
              </div>
            </Link>
          )}
        </div>
